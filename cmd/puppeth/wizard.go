...
type wizard struct {
	...
	services map[string][]string   // Frogeum services known to be running on servers
...
// converts it to an Frogeum address. If an empty line is entered, the default
// value is returned.
