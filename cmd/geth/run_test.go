...
import (
	...
	"github.com/frogeum/go-frogeum/internal/cmdtest"
	"github.com/frogeum/go-frogeum/rpc"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "gfro-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "gfro-test" in runGfro.
	reexec.Register("gfro-test", func() {
...
// spawns gfro with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runGfro(t *testing.T, args ...string) *testgfro {
	tt := &testgfro{}
	...
	// Boot "gfro". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("gfro-test", args...)
