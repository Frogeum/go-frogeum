...
func (mc *mockCaller) CallContract(ctx context.Context, call frogeum.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call frogeum.CallMsg) ([]byte, error) {
