 ...
 * @author Gary Rong<garyrong@frogeum.org>, Martin Swende <martin.swende@frogeum.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the frogeum.
    uint sectionSize;
