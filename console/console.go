...
import (
	...
	"github.com/frogeum/go-frogeum/internal/jsre"
	"github.com/frogeum/go-frogeum/internal/jsre/deps"
	"github.com/frogeum/go-frogeum/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Frogeum requests through
...
// Welcome show summary of current Gfro instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gfro JavaScript console!\n\n"

	// Print some generic Gfro metadata
