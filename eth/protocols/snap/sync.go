...
// Syncer is an Frogeum account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Frogeum state over the
// snap protocol.
