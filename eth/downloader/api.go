...
// Syncing provides information when this nodes starts synchronising with the Frogeum network and when it's finished.
...
type SyncingResult struct {
	...
	Status  frogeum.SyncProgress `json:"status"`
}
