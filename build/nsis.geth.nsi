...
# 1. install gfro for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gfro
# 5. create gfro, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable POPCATEUM_SOCKET
...
!define GROUPNAME "Frogeum"
!define APPNAME "Gfro"
!define DESCRIPTION "Official Go implementation of the Frogeum protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gfro is installed global
