...
// all blocks' seal as valid, though they still have to conform to the Frogeum
// consensus rules.
...
// still have to conform to the Frogeum consensus rules.
...
// they still have to conform to the Frogeum consensus rules.
