...
func makeMiner(genesis *core.Genesis) (*node.Node, *eth.Frogeum, error) {
	// Define the basic configurations for the Frogeum node
	...
	// Create the node and configure a full Frogeum node on it
