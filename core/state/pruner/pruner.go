...
pruning. Remember don't start the Gfro without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "gfro snapshot prune-state --help" for more details.
`
