...
// stateObject represents an Frogeum account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of frogeum address of the account
	data     Account
	db       *StateDB
...
// Account is the Frogeum consensus representation of accounts.
