...
// It can be used for testing that restart Gfro normally.
...
// It can be used for testing that restart Gfro after the crash.
...
// Tests a Gfro restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gfro was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gfro was crashed and restarts with a broken snapshot. In this case
...
// Tests a Gfro was running with snapshot enabled. Then restarts without
...
// Tests the Gfro was running with snapshot enabled and resetHead is applied.
...
// Tests the Gfro was running with a complete snapshot and then imports a few
