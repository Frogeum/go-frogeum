...
// Package forkid implements EIP-2124 (https://eips.frogeum.org/EIPS/eip-2124).
package forkid
...
// NewID calculates the Frogeum fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Frogeum fork ID from an existing chain instance.
