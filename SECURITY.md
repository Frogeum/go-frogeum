...
Please see [Releases](https://github.com/frogeum/go-frogeum/releases). We recommend using the [most recently released version](https://github.com/frogeum/go-frogeum/releases/latest).

## Audit reports

Audit reports are published in the `docs` folder: https://github.com/frogeum/go-frogeum/tree/master/docs/audits 

| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `gfro` | 20170425 | [pdf](https://github.com/frogeum/go-frogeum/blob/master/docs/audits/2017-04-25_Gfro-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/frogeum/go-frogeum/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |

## Reporting a Vulnerability

**Please do not file a public ticket** mentioning the vulnerability.

To find out how to disclose a vulnerability in Frogeum visit [https://bounty.frogeum.org](https://bounty.frogeum.org) or email bounty@frogeum.org. Please read the [disclosure page](https://github.com/frogeum/go-frogeum/security/advisories?state=published) for more information about publically disclosed security vulnerabilities.

Use the built-in `gfro version-check` feature to check whether the software is affected by any known vulnerability. This command will fetch the latest [`vulnerabilities.json`](https://gfro.frogeum.org/docs/vulnerabilities/vulnerabilities.json) file which contains known security vulnerabilities concerning `gfro`, and cross-check the data against its own version number.
