...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gfro.ipc", false, filepath.Join(os.TempDir(), "gfro.ipc")},
		{"data", "gfro.ipc", false, "data/gfro.ipc"},
		{"data", "./gfro.ipc", false, "./gfro.ipc"},
		{"data", "/gfro.ipc", false, "/gfro.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gfro.ipc", true, `\\.\pipe\gfro.ipc`},
		{"data", "gfro.ipc", true, `\\.\pipe\gfro.ipc`},
		{"data", `\\.\pipe\gfro.ipc`, true, `\\.\pipe\gfro.ipc`},
	}
