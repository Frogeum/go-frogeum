...
import (
	...
	"github.com/frogeum/go-frogeum/p2p/simulations"
	"github.com/frogeum/go-frogeum/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	frogeum, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, frogeum, &config)
	if err != nil {
		return nil, err
	}
	return frogeum, nil
